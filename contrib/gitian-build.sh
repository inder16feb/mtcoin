...
VERSION=
commit=false
url=https://github.com/inder16feb/mtcoin
proc=2
mem=2000
lxc=true
...
-u|--url	Specify the URL of the repository. Default is https://github.com/inder16feb/mtcoin
...
then
    ...
    git clone https://github.com/inder16feb/gitian.sigs.git
    git clone https://github.com/inder16feb/mtcoin-detached-sigs.git
