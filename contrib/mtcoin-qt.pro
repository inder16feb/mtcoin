...
RESOURCES += src/qt/mtcoin.qrc src/qt/mtcoin_locale.qrc

TRANSLATIONS += src/qt/locale/mtcoin_bg.ts \
                src/qt/locale/mtcoin_de.ts \
                src/qt/locale/mtcoin_en.ts \
                src/qt/locale/mtcoin_es.ts \
                src/qt/locale/mtcoin_fi.ts \
                src/qt/locale/mtcoin_fr.ts \
                src/qt/locale/mtcoin_it.ts \
                src/qt/locale/mtcoin_ja.ts \
                src/qt/locale/mtcoin_pl.ts \
                src/qt/locale/mtcoin_pt.ts \
                src/qt/locale/mtcoin_ru.ts \
                src/qt/locale/mtcoin_sk.ts \
                src/qt/locale/mtcoin_sv.ts \
                src/qt/locale/mtcoin_vi.ts \
                src/qt/locale/mtcoin_zh_CN.ts \
                src/qt/locale/mtcoin_zh_TW.ts
