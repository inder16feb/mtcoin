...
Mtcoin now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<mtcoin_address\> \<monthly_payment_mtcoin\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ MTC, _12_ times over the course of a year totaling _24000_ MTC.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<mtcoin_address\> \<monthly_payment_mtcoin\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` MTC.
 ...
 * vote-many          - Vote on a Mtcoin initiative
 * vote-alias         - Vote on a Mtcoin initiative
 * vote               - Vote on a Mtcoin initiative/budget
