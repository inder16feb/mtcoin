...
This mechanism has been integrated into Bitcore-Node-Mtcoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/mtcoin/insight-api-mtcoin#web-socket-api](https://github.com/mtcoin/insight-api-mtcoin#web-socket-api)
* API: [https://github.com/mtcoin/insight-api-mtcoin#swifttx-transactions](https://github.com/mtcoin/insight-api-mtcoin#swifttx-transactions)
...
By default, the Mtcoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Mtcoin Core daemon:
