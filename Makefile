...
DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/Makefile.am \
	...
	$(top_srcdir)/src/config/mtcoin-config.h.in \
...
CONFIG_HEADER = $(top_builddir)/src/config/mtcoin-config.h
...
ACLOCAL = ${SHELL} /home/inder/Desktop/oryxcoin/build-aux/missing aclocal-1.14
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /home/inder/Desktop/oryxcoin/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/inder/Desktop/oryxcoin/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/inder/Desktop/oryxcoin/build-aux/missing automake-1.14
AWK = gawk
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = mtcoin-cli
BITCOIN_DAEMON_NAME = mtcoind
BITCOIN_GUI_NAME = mtcoin-qt
BITCOIN_TX_NAME = mtcoin-tx
...
MAINT = 
MAKEINFO = ${SHELL} /home/inder/Desktop/oryxcoin/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
PACKAGE_STRING = Mtcoin Core 1.1.0
...
ZMQ_CFLAGS = 
ZMQ_LIBS = 
abs_builddir = /home/inder/Desktop/oryxcoin
abs_srcdir = /home/inder/Desktop/oryxcoin
abs_top_builddir = /home/inder/Desktop/oryxcoin
abs_top_srcdir = /home/inder/Desktop/oryxcoin
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/inder/Desktop/oryxcoin/build-aux/install-sh
...
OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  ...
  $(OSX_APP)/Contents/MacOS/Mtcoin-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/mtcoin-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/mtcoin-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/mtcoin-config.h
$(top_srcdir)/src/config/mtcoin-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/mtcoin-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/MacOS/Mtcoin-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Mtcoin-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Mtcoin-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
