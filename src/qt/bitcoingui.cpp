...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Mtcoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Mtcoin Core"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Mtcoin Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("Mtcoin Core"); // default title
