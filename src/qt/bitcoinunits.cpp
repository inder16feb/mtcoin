...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case MTC:
            return QString("MTC");
        case mMTC:
            return QString("Milli-MTC (1 / 1" THIN_SP_UTF8 "000)");
        case uMTC:
            return QString("Micro-MTC (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case MTC:
            return QString("TestMTCs");
        case mMTC:
            return QString("Milli-TestMTC (1 / 1" THIN_SP_UTF8 "000)");
        case uMTC:
            return QString("Micro-TestMTC (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
