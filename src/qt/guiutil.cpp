...
void setupAddressWidget(QValidatedLineEdit* widget, QWidget* parent)
{
    ...
    widget->setPlaceholderText(QObject::tr("Enter a MTC address (e.g. %1)").arg("o7VFR83SQbiezrW72hjcWJtcfip5krte2Z"));
#endif
...
void openConfigfile()
{
    ...
    /* Open mtcoin.conf with the associated application */
