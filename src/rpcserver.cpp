...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Mtcoin features */
        {"mtcoin", "masternode", &masternode, true, true, false},
        {"mtcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"mtcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"mtcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"mtcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"mtcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"mtcoin", "startmasternode", &startmasternode, true, true, false},
        {"mtcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"mtcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"mtcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"mtcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"mtcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"mtcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"mtcoin", "mnbudget", &mnbudget, true, true, false},
        {"mtcoin", "preparebudget", &preparebudget, true, true, false},
        {"mtcoin", "submitbudget", &submitbudget, true, true, false},
        {"mtcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"mtcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"mtcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"mtcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"mtcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"mtcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"mtcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"mtcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"mtcoin", "mnsync", &mnsync, true, true, false},
        {"mtcoin", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
