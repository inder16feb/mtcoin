/* src/config/mtcoin-config.h.  Generated from mtcoin-config.h.in by configure.  */
/* src/config/mtcoin-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_STRING "Mtcoin Core 1.1.0"
