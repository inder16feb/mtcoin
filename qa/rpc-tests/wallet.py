...
#   c) node1 mines 32 blocks, so now node 0 has 500000MTC, node 1 has 4250MTC, node2 has none.
#   d) node0 sends 601 MTC to node2, in two transactions (301 MTC, then 300 MTC).
