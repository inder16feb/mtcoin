Contributing to Mtcoin Core
==================================

The Mtcoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Mtcoin Core project, and is not to be
confused with overall Mtcoin Network Protocol consensus changes.

Whether a pull request is merged into Mtcoin Core rests with the project merge
...
Patches that change Mtcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Mtcoin consensus, it must have been
...
The project leader is the release manager for each Mtcoin Core release.
